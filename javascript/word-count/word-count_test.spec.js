...
describe("words()", function() {
  ...
  it("counts multiple occurrences", function() {
    var expectedCounts = { one: 1, "two!": 1, fish: 3, "fish,": 1, red: 1, blue: 1, "javascript!!&@$%^&": 1 };
    expect(words("one fish, two! javascript!!&@$%^& fish red fish blue fish")).toEqual(expectedCounts);
  });
